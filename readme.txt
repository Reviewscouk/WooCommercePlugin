...
Step 2: Enter your REVIEWS.io API Credentials and Configure all settings.

Step 3: Full Instructions for integration can be found on the REVIEWS.io Dashboard at Company Setup > Automated Review Collection > WooCommerce.
...
REVIEWS.io plans are paid monthly or yearly. We make it simple to start - and stop - your service at any time. All contracts are month to month unless you sign up for an annual plan.
...
## IS MY CUSTOMER DATA SAFE WITH REVIEWS.io?

We can ensure that all data sent to REVIEWS.io is handled securely. All data is stored on UK based encrypted servers.
...
No one at REVIEWS.io works on commission, so you don't have to worry about anyone selling you on a pricing plan you don't need. We're simply here to help you have the best experience possible.
Our customer service team is the largest team at REVIEWS.io, we are passionate that our clients have access to a knowledgeable support team.
