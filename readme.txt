...
== Changelog ==
= 1.5.7 =
* Fix - Prevent fatal error when the `page` URL parameter is malformed (e.g. submitted as an array).
...
= 1.5.0 =
* Update - Add native support for WooCommerce Global Unique ID field in feed.

= 1.4.4 =
* Fix - Check for woocommerce in getProduct

= 1.4.3 =
* Fix - Fixed a bug in product feeds causing certain characters to be encoded
...
= 1.3.7 =
* Fix - Fix Polaris shortcode to not print at the top of the screen.

= 1.3.6 =
* Fix - Change Carousel Widget to an inline script instead of returning a script in the shortcode.

= 1.3.5 =
* Fix - Carousel default styles not working.

= 1.3.4 =
* Fix - Changed escaping on rich snippet url to ignore HTML entities.

= 1.3.3 =
* Fix - Remove excessive escaping on user custom javascript config and move a few advanced Product Review Widget configuration options to correct tab on widget settings page.
